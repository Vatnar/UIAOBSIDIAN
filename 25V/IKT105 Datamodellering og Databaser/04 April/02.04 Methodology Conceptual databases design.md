...
- Data dictionary to supplement the data model diagrams.![[image-2.png|849x389]]
- ![[image-3.png]]
...
role
group
group called assistants
staff (number, name, address, position, salary)
details of branch
property
property data
property number
property address (streert, city, postcode)
property type
number of rooms
monthly rent
property details
...
newspapers
property owner
private owner owner number, name address telephone number, email, password

business owner, name, type of business, address, telephone number
email, password, contact info.

client
client data, name, client number, email, preferred accommodation
maximum rent, 
registration
lease
lease number
