...
+ Linux
+ IDE, teste på linux.
+ utivkle uten å måtte bruke ekte hardware
+ Koden blir krysskompilert for powerpc og så deployert til missilcomputeren.

### Fra modell til kode
+  genererrer .idl, IDL Interface Description Language
+ 
