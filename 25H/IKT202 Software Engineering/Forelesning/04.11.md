...
1 Logical Views focus on support for user functionality
	- Use case, reqs
2 Development and implementation units
	- Class, entity, package
3 Dynamic: Run-Time and components
	- Behavioural:: sequence
4 Deployment Servers and configuration
	-
- **Scenarios tie the views together**
- Scenario is Use case description
- Or how fast something should happen
